...
CREATE TABLE IF NOT EXISTS `mydb`.`usuário` (
  ...
  PRIMARY KEY (`idusuário`, `pedidos_idpedidos`),
  INDEX `fk_usuário_pedidos1_idx` (`pedidos_idpedidos` ASC) VISIBLE,
  CONSTRAINT `fk_usuário_pedidos1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`endereço` (
  ...
  `usuário_idusuário` INT NOT NULL,
  PRIMARY KEY (`idEndereço`, `usuário_idusuário`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`acessorios` (
  `idacessorios` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `preco` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`tipomidia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tipomidia` (
  `idtipomidia` INT NOT NULL AUTO_INCREMENT,
